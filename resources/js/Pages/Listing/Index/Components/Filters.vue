<template>
    <form @submit.prevent="filter" action="">
        <div class="mb-8 mt-4 flex flex-wrap gap-2">
            ...
            <div class="flex flex-nowrap items-center">
                <input type="text" placeholder="Area from" v-model="filterForm.areaFrom"/>
                <input type="text" placeholder="Area to" v-model="filterForm.areaTo"/>
            </div>
