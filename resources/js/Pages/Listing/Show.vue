<template>
    <div class="flex flex-col-reverse mid:grid md:grid-cols-12 gap-4">
        <Box class="md:col-span-7 flex items-center w-full">
            <div v-if="listing.images.length" class="grid grid-col-2 gap-1">
        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div>
                    ...
                    class="w-full h-4 bg-gray-200 rounded-lg appearence-none cursor-pointer dark:bg-gray-700">
